<div class="body">
						...
						<div class="header-row">
								...
								<div class="header-row">
									<div class="header-logo">
										<a href="demo-restaurant.html">
											<img alt="Porto" width="123" height="48" src="media/img/demos/restaurant/logo.png">
										</a>
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a class="nav-link" href="demo-restaurant.html">
															Home
														</a>
													</li>
													<li>
														<a class="nav-link active" href="demo-restaurant-menu.html">
															Menu
														</a>
													</li>
													<li>
							...
							<div class="header-column header-column-search justify-content-end align-items-center d-flex w-auto flex-row">
								...
								<a href="https://www.tripadvisor.com/" class="text-decoration-none" target="_blank">
									<img width="32" height="32" src="media/img/demos/restaurant/icons/tripadvisor.svg" alt="Tripadvisor Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-dark svg-fill-color-hover-primary', 'fadeIn': false}" />
								</a>
			...
			<div role="main" class="main">
				...
				<section class="section section-with-shape-divider section-height-3 overlay overlay-show border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '120%', 'fadeIn': true}" data-image-src="media/img/demos/restaurant/backgrounds/background-5.jpg">
						...
						<div class="row mb-3">
							<div class="col">
								<ul class="breadcrumb d-block text-center custom-font-secondary text-6 font-weight-medium positive-ls-3">
									...
									<li class="active text-color-primary">Menu</li>
								</ul>
								<h1 class="d-block text-color-light font-weight-bold text-center text-12 positive-ls-1 line-height-2 mb-0">Menu</h1>
							</div>
						</div>
					</div>
				...
				<div id="menu" class="container py-4 my-5">
					<div class="row justify-content-center justify-content-lg-start">
						<div class="col-md-10 col-lg-6 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="850">
							<img src="media/img/demos/restaurant/menu/menu-1.jpg" class="img-fluid box-shadow-4" alt="Starters Menu Background Image" />
						</div>
					</div>
						...
						<div class="col-md-10 col-lg-7 ms-lg-auto appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="500">
							<div class="card box-shadow-4 border-0 rounded-0">
								<div class="card-body p-5">
									<h4 class="text-color-dark font-weight-bold positive-ls-3 mb-3">APPERO</h4>
									<hr class="custom-divider-size-1 bg-color-grey-scale-2 mt-2 mb-4">

									<?php foreach( $appero as $alcool ) : ?>

									<div class="custom-menu-item">
		                                <div class="custom-menu-item-details">
		                                    <div class="custom-menu-item-title">
		                                    	<h5 class="custom-secondary-font text-transform-none font-weight-semibold text-4 mb-0"><?= $alcool['title']; ?></h5>
		                                    </div>
		                                    ...
		                                    <div class="custom-menu-item-price">
		                                    	<strong class="custom-font-secondary text-color-dark text-4 positive-ls-3">
		                                    		<span class="text-2-5">$</span><?= $alcool['price']; ?>
		                                    	</strong>
		                                    </div>
		                                </div>
		                                <div class="custom-menu-item-desc">
		                                    <p class="text-2-5 line-height-4"><?= $alcool['description']; ?></p>
		                                </div>
		                            </div>
					...
					<div class="row justify-content-center justify-content-lg-start pt-4 mt-5">
						<div class="col-md-10 col-lg-6 ms-lg-auto appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="550">
							<img src="media/img/demos/restaurant/menu/menu-2.jpg" class="img-fluid box-shadow-4" alt="Mains Menu Background Image" />
						</div>
					</div>
					...
					<div class="row justify-content-center justify-content-lg-start">
						<div class="col-md-10 col-lg-6 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="550">
							<img src="media/img/demos/restaurant/menu/menu-3.jpg" class="img-fluid box-shadow-4" alt="Dessert Menu Background Image" />
						</div>
					</div>
					<div class="row justify-content-center justify-content-lg-start custom-negative-margin-top-1">
				...
				<div class="container pt-3 mt-4">
					<div class="row justify-content-center">
						<div class="col-11 col-sm-9 col-lg-6 text-center">
							<a href="demo-restaurant.html">
								<img src="media/img/demos/restaurant/logo-footer.png" class="img-fluid mb-3" alt="Porto Logo at footer" />
							</a>
							<p class="text-color-grey text-3-5 px-4 mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque molestie vel turpis a sodales.</p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-3">
							<ul class="list list-unstyled">
								<li class="d-flex justify-content-center justify-content-lg-start">
									<img width="27" height="27" src="media/img/demos/restaurant/icons/phone.svg" alt="Phone Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light position-relative bottom-2'}" />
									<a href="tel:+1234567890" class="text-decoration-none text-color-light text-color-hover-primary font-weight-bold line-height-7 text-3-5 ms-2">(800) 123-4567</a>
								</li>
								<li class="d-flex justify-content-center justify-content-lg-start my-4">
									<img width="27" height="27" src="media/img/demos/restaurant/icons/email.svg" alt="Email Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />
									<a href="tel:+1234567890" class="text-decoration-none text-color-light text-color-hover-primary font-weight-bold line-height-7 text-3-5 ms-2">porto@domain.com</a>
								</li>
								<li class="d-flex justify-content-center justify-content-lg-start">
									<img width="27" height="27" src="media/img/demos/restaurant/icons/location.svg" alt="Location Icon" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light position-relative top-1'}" />
									<p class="text-color-light font-weight-bold line-height-9 line-height-lg-7 text-3-5 ms-2">123 Street Name, New York, NY 10000, USA</p>
								</li>
							</ul>
						</div>
						...
						<div class="col-lg-3">
							...
							<ul class="list list-icons list-icons-sm d-flex flex-column align-items-center align-items-lg-end">
								<li>
									...
									<a href="demo-restaurant-contact.html" class="link-hover-style-1 ms-1"> Contact Us</a>
								</li>
								<li>
									<i class="fas fa-angle-right text-color-default"></i>
									<a href="demo-restaurant-menu.html" class="link-hover-style-1 ms-1"> Our Menu</a>
								</li>
								<li>
									<i class="fas fa-angle-right text-color-default"></i>
								...
								<li>
									<i class="fas fa-angle-right text-color-default"></i>
									<a href="demo-restaurant-blog.html" class="link-hover-style-1 ms-1"> Our Blog</a>
								</li>
								<li>
									<i class="fas fa-angle-right text-color-default"></i>
					...
					<div class="container">
						<div class="row">
							<div class="col text-center">
								<p class="text-color-grey text-3-5">Porto Restaurant © 2022. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
